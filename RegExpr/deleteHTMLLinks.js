/* 
    Solution for the https://www.hackerrank.com/challenges/detect-html-links/problem
*/

let re = new RegExp(/<a.*?href="(.*?)".*?>(.*?)<\/a>/ig);
...
<div class="body">
<ul>
<li class="interwiki-simple"><a href="//simple.wikipedia.org/wiki/" title="" lang="simple" hreflang="simple"><b>Dansk</b></a></li>
...
let results = input.replace(re, function(_,href,text) {
